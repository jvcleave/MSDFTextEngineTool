...
// Per-glyph quad payload emitted by MSDFExampleTextRenderer.swift.
...
// Shared uniforms; layout must match the Swift struct exactly.
struct MSDFUniforms
{
    float2 viewportSize;
    float distanceRange;
...
// Expands each glyph instance into two triangles and maps to clip space.
...
// Samples MSDF and derives edge alpha using screen-space derivatives.
